            ...
            children: [
              ...
              if (_model.isEdit != 'False')
                InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('ACCOUNT_DETAILS_Text_3xqpphhs_ON_TAP');
                    setState(() {
                      _model.isEdit = 'False';
                    });
                  },
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'To change account type use the Pamo Connect App',
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        fontFamily: 'Montserrat',
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'ACCOUNT_DETAILS_Container_5abio4dw_ON_TA');
                        ...
                        Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'ACCOUNT_DETAILS_Text_cqwmvbx7_ON_TAP');
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    final usersUpdateData =
                                      ...
                                      email: _model
                                          .emailInputModel.textController.text,
