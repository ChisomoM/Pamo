...
import 'pick_ticket_model.dart';
export 'pick_ticket_model.dart';

class PickTicketWidget extends StatefulWidget {
  const PickTicketWidget({
    Key? key,
    this.eve,
  }) : super(key: key);
  ...
  @override
  _PickTicketWidgetState createState() => _PickTicketWidgetState();
}

class _PickTicketWidgetState extends State<PickTicketWidget> {
  late PickTicketModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PickTicketModel());
  }
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Builder(
                                builder: (context) => InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PICK_TICKET_COMP_Ticket_ON_TAP');
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'PICK_TICKET_CONTINUE_TO_CART_BTN_ON_TAP');

                          context.pushNamed('Checkout4');
                        },
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('PICK_TICKET_COMP_CANCEL_BTN_ON_TAP');
                        context.pop();
                      },
                      text: 'Cancel',
                      options: FFButtonOptions(
