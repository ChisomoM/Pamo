      ...
      child: FutureBuilder<List<EventsRecord>>(
        future: (_model.firestoreRequestCompleter ??=
                Completer<List<EventsRecord>>()
                  ..complete(queryEventsRecordOnce(
                    queryBuilder: (eventsRecord) =>
                        eventsRecord.where('event_Org', isEqualTo: widget.user),
                    limit: 10,
                  )))
            .future,
        builder: (context, snapshot) {
          ...
          return RefreshIndicator(
            onRefresh: () async {
              logFirebaseEvent('EVENT_LIST_ListView_hy3to92f_ON_PULL_TO_');
              ...
              itemBuilder: (context, listViewIndex) {
                ...
                return Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('EVENT_LIST_COMP_menuItem_ON_TAP');
