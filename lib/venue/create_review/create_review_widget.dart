...
class CreateReviewWidget extends StatefulWidget {
  ...
  final DocumentReference? venueR;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Let people know what you thing about the place',
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CREATE_REVIEW_COMP_REVIEW_BTN_ON_TAP');

                        final venueRatingsCreateData =
                            createVenueRatingsRecordData(
                          userRating: currentUserReference,
                          review: _model.shortBioController.text,
                          rating: _model.ratingBarValue,
                        );
                        await VenueRatingsRecord.createDoc(widget.venueR!)
                            .set(venueRatingsCreateData);
                      },
                      text: 'Review',
