...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Moments',
          path: '/moments',
          builder: (context, params) => MomentsWidget(),
        ),
        FFRoute(
          name: 'CreateProfile',
          path: '/createProfile',
          builder: (context, params) => CreateProfileWidget(
            accountType: params.getParam(
                'accountType', ParamType.DocumentReference, false, ['users']),
          ),
        ),
        FFRoute(
          name: 'login',
        ...
        FFRoute(
          name: 'AiCaption',
          path: '/aiCaption',
          builder: (context, params) => AiCaptionWidget(),
        ),
        FFRoute(
          name: 'SignUp',
          path: '/signUp',
        ...
        FFRoute(
          name: 'OtherBizUserProfile',
          path: '/OtherBizUserProfile',
          builder: (context, params) => OtherBizUserProfileWidget(
            user: params.getParam(
                'user', ParamType.DocumentReference, false, ['users']),
            userN: params.getParam('userN', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'eventDetails',
        ...
        FFRoute(
          ...
          builder: (context, params) => CategoryWidget(
            categ: params.getParam('categ', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'Saved',
        ...
        FFRoute(
          name: 'ExploreM',
          path: '/exploreM',
          builder: (context, params) => ExploreMWidget(),
        ),
        FFRoute(
          name: 'searcho',
          path: '/searcho',
          builder: (context, params) => SearchoWidget(),
        ),
        FFRoute(
          name: 'EventSearch',
          path: '/eventSearch',
        ...
        FFRoute(
          name: 'momentDetails',
          path: '/momentDetails',
          builder: (context, params) => MomentDetailsWidget(
            momentRef: params.getParam(
                'momentRef', ParamType.DocumentReference, false, ['moments']),
            commentNum: params.getParam('commentNum', ParamType.int),
          ),
        ),
        FFRoute(
          name: 'venueDetails',
        ...
        FFRoute(
          ...
          asyncParams: {
            'event':
                getDoc(['moments', 'comments'], CommentsRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          builder: (context, params) => MyTicketWidget(
            ticket: params.getParam(
                'ticket', ParamType.DocumentReference, false, ['orders']),
          ),
        ),
        FFRoute(
          name: 'onBoarding',
