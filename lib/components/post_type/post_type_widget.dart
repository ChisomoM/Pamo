...
class _PostTypeWidgetState extends State<PostTypeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostTypeModel());
  }
          ...
          children: [
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('POST_TYPE_COMP_CreateMomentBtn_ON_TAP');
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('POST_TYPE_CancelCreatePostBtn_ON_TAP');
