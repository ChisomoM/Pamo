...
class CreateMomentWidget extends StatefulWidget {
  const CreateMomentWidget({Key? key}) : super(key: key);
...
class _CreateMomentWidgetState extends State<CreateMomentWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'createMoment'});
        ...
        actions: [
          Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('CREATE_MOMENT_close_rounded_ICN_ON_TAP');
                context.pop();
              },
            ),
          ),
          ...
          children: [
            Align(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('CREATE_MOMENT_PAGE_Text_ugy1zs6t_ON_TAP');
            ...
            Padding(
              ...
              child: Container(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'CREATE_MOMENT_MediaDisplay_m0bqi384_ON_T');
                    final selectedMedia =
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Caption',
                          hintText: 'Caption it! Describe your moment here...',
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('CREATE_MOMENT_POST_MOMENT_BTN_ON_TAP');

                  final momentsCreateData = createMomentsRecordData(
                    caption: _model.textController.text,
                    userPosting: currentUserReference,
                    postMedia: _model.uploadedFileUrl,
                    postTime: getCurrentTimestamp,
                  );
                  await MomentsRecord.collection.doc().set(momentsCreateData);
